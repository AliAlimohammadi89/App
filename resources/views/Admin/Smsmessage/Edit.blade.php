            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                         <form enctype="multipart/form-data"  action="{{ route('Categories.update', $Category_data->id) }}" method="POST" name="update_category">

                            {{ csrf_field() }}
                            @method('PATCH')
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">عنوان مجموعه</label>
                                    <input value="{{ $Category_data->title}}" type="text" class="form-control" name="title" placeholder="عنوان را وارد کنید">
                                </div>
                                <div class="form-group">
                                    <label>توضیحات مجموعه</label>
                                    <textarea class="form-control" rows="3" name="description" placeholder="وارد کردن توضیحات ...">{{$Category_data->description}}</textarea>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputFile">ارسال فایل</label>
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input value="{{ $Category_data->image}}" type="file" name="image" class="custom-file-input" id="exampleInputFile">
