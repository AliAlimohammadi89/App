            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form enctype="multipart/form-data" role="form" action="{{ route('Products.update', $Product_data->id) }}" name="update_product" method="POST">
                            {{ csrf_field() }}
                            @method('PATCH')
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $Product_data->title }}" class="form-control" name="title" placeholder="عنوان را وارد کنید">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">قیمت محصول</label>
                                    <input value="{{$Product_data->price}}" type="text" class="form-control" name="price" placeholder="قیمت را وارد کنید">
                                </div>
                                <div class="form-group">
                                    <label>توضیحات محصول</label>
                                    <textarea class="form-control" rows="3" name="description" placeholder="وارد کردن توضیحات ...">{{$Product_data->description}}</textarea>
                                </div>
