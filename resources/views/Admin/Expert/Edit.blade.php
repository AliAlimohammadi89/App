                        ...
                        <form enctype="multipart/form-data" role="form" action="{{ route('Experts.update', $Expert_data->id) }}" name="update_Expert" method="POST">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $Expert_data->title }}" class="form-control" name="title" placeholder="عنوان را وارد کنید">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">قیمت محصول</label>
                                    <input value="{{$Expert_data->price}}" type="text" class="form-control" name="price" placeholder="قیمت را وارد کنید">
                                </div>
                                <div class="form-group">
